...
export class EntryController {
  static async favorite(req: Request, res: Response<IResponse>) {
    ...
    const { userId, entryId, favorite } = req.body;
    ...
    if (doc.modifiedCount === 0) {
      return res
        ...
        .json(userResponses.could_not_update("Journal entry favorite status could not be updated."));
    }
